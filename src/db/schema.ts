...
export const users = pgTable(
  ...
  (table) => ({
    emailTenantIdx: uniqueIndex('user_email_tenant_idx').on(
      table.email,
      table.tenantId,
    ),
...
export const projects = pgTable(
  ...
  (table) => ({
    slugTenantIdx: uniqueIndex('project_slug_tenant_idx').on(
      table.slug,
      table.tenantId,
    ),
...
export const roles = pgTable(
  ...
  (table) => ({
    slugTenantIdx: uniqueIndex('role_slug_tenant_idx').on(
      table.slug,
      table.tenantId,
    ),
...
export const rolePermissions = pgTable(
  ...
  (table) => ({
    ...
    permissionIdx: index('role_permission_permission_idx').on(
      table.permissionId,
    ),
  }),
);
...
export const userProjectAccess = pgTable(
  ...
  (table) => ({
    userProjectIdx: uniqueIndex('user_project_idx').on(
      table.userId,
      table.projectId,
    ),
